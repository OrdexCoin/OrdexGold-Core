...
bech32_templates = [
  ...
  ('oxg',    0, 20, (False, 'main',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('oxg',    0, 32, (False, 'main',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('oxg',    1, 32, (False, 'main',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('oxg',    2,  2, (False, 'main',    None, True), Encoding.BECH32M, (OP_2, 2)),
  ('toxg',    0, 20, (False, 'test',    None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('toxg',    0, 32, (False, 'test',    None, True), Encoding.BECH32,  p2wsh_prefix),
  ('toxg',    1, 32, (False, 'test',    None, True), Encoding.BECH32M, p2tr_prefix),
  ('toxg',    3, 16, (False, 'test',    None, True), Encoding.BECH32M, (OP_3, 16)),
  ('toxg',    0, 20, (False, 'signet',  None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('toxg',    0, 32, (False, 'signet',  None, True), Encoding.BECH32,  p2wsh_prefix),
  ('toxg',    1, 32, (False, 'signet',  None, True), Encoding.BECH32M, p2tr_prefix),
  ('toxg',    3, 32, (False, 'signet',  None, True), Encoding.BECH32M, (OP_3, 32)),
  ('roxg',  0, 20, (False, 'regtest', None, True), Encoding.BECH32,  p2wpkh_prefix),
  ('roxg',  0, 32, (False, 'regtest', None, True), Encoding.BECH32,  p2wsh_prefix),
  ('roxg',  1, 32, (False, 'regtest', None, True), Encoding.BECH32M, p2tr_prefix),
  ('roxg', 16, 40, (False, 'regtest', None, True), Encoding.BECH32M, (OP_16, 40))
]
...
bech32_ng_templates = [
  ...
  ('toxg',   17, 32, Encoding.BECH32M, False, False, False),
  ('roxg',  3,  1, Encoding.BECH32M, False, False, False),
  ('oxg',   15, 41, Encoding.BECH32M, False, False, False),
  ('toxg',    0, 16, Encoding.BECH32,  False, False, False),
  ('roxg',  0, 32, Encoding.BECH32,  True,  False, False),
  ('oxg',    0, 16, Encoding.BECH32,  True,  False, False),
  ('toxg',    0, 32, Encoding.BECH32,  False, True,  False),
  ('roxg',  0, 20, Encoding.BECH32,  False, False, True),
  ('oxg',    0, 20, Encoding.BECH32M, False, False, False),
  ('toxg',    0, 32, Encoding.BECH32M, False, False, False),
  ('roxg',  0, 20, Encoding.BECH32M, False, False, False),
  ('oxg',    1, 32, Encoding.BECH32,  False, False, False),
  ('toxg',    2, 16, Encoding.BECH32,  False, False, False),
  ('roxg', 16, 20, Encoding.BECH32,  False, False, False),
]
