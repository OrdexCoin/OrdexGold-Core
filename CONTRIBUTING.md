Contributing to OrdexGold Core
============================

The OrdexGold Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the OrdexGold Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/ordexgold-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to ordexgold-qt
...
The following applies to code changes to the OrdexGold Core project (and related
projects such as libsecp256k1), and is not to be confused with overall OrdexGold
Network Protocol consensus changes.

Whether a pull request is merged into OrdexGold Core rests with the project merge
...
Patches that change OrdexGold consensus rules are considerably more involved than
...
Where a patch set proposes to change the OrdexGold consensus, it must have been
...
The project leader is the release manager for each OrdexGold Core release.
