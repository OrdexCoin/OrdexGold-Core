...
"""Verify that starting ordexgold with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start ordexgold with -h for help text")
        ...
        self.log.info("Start ordexgold with -version for version information")
        ...
        self.log.info("Start ordexgoldd with -fakearg to make sure it does not start")
