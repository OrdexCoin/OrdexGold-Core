# Support for Output Descriptors in OrdexGold Core

Since OrdexGold Core v0.17, there is support for Output Descriptors. This is a
...
- Segwit addresses (bech32, of the form `oxg1...` for mainnet or `toxg1...` for testnet, defined in [BIP 173](https://github.com/bitcoin/bips/blob/master/bip-0173.mediawiki)).
...
existing OrdexGold Core wallets, a convenience function `combo` is
