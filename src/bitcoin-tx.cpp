...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " ordexgold-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  ordexgold-tx [options] <hex-tx> [commands]  Update hex-encoded ordexgold transaction\n" +
            "or:     ordexgold-tx [options] -create [commands]   Create hex-encoded ordexgold transaction\n" +
            "\n";
