...
Modular library for supporting OrdexGold's implementation of the MWEB (Mimblewimble Extension Block). 
...
### crypto/
Crypto libraries not provided by ordexgold or secp256k1-zkp.
...
While boost\:\:filesystem is already pulled in by ordexgold, I was uncomfortable with its API and its handling of unicode conversions.
...
and just replace the more-limited secp256k1 dependency that's already included in OrdexGold.
