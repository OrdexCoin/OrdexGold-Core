...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The OrdexGold Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "OrdexGold Core"
...
#define PACKAGE_BUGREPORT "https://github.com/OrdexCoin/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "OrdexGold Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "OrdexGold Core 0.21.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ordexgold"
